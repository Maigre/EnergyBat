<?php
	function Initialize($gauche,$haut,$largeur,$hauteur,$bord_col,$txt_col,$bg_col,$prog_col)
	{
		//texte
		...
		//fond noir
		echo '<div id="backside" style="position:absolute;top:'.($haut+1); //+1
	...
	function ProgressBar($indice)
	{
		if ($indice==100)
		{
			...
			echo "document.getElementById('backside').style.display='none';";
